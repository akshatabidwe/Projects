<?php
 ...
 <body   >
      ...
      <body>
           ...
           <h1 style="font-weight: bold;color:red; text-align:center;font: size 60px;">Pradhan Mantri Fasal Bima Yojana (PMFBY)</h1>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     ...
                     <div class="card">
                          <div class="aligncenter">
                                    ...
                                    <img style="height:200px;width:50%" src="../Images/schemes/PMFBY.jpg" alt="logo">
