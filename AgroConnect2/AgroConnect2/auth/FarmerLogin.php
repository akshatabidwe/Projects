...
if (isset($_POST['login'])) {
    // Include your database connection file here (assuming you have a $con variable)
    ...
    if ($count_rows == 0) {
        ...
        // Fetch the farmer ID and store it in session
        $row = mysqli_fetch_array($run_query);
        $_SESSION['farmer_id'] = $row['farmer_id'];
        
        // Redirect to the farmer's homepage
        header("Location: ../FarmerPortal/farmerHomepage.php");
        exit();
    }
}
?>